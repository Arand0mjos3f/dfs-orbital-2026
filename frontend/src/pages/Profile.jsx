    ...
    <div className="min-h-dvh bg-[#F8FAFC] px-5 pb-8 pt-5">
      ...
      <section className="rounded-[24px] bg-white p-5 shadow-[0_8px_30px_rgba(15,23,42,0.05)]">
        <div className="flex items-center gap-4">
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-indigo-100 to-sky-100 text-2xl">
            🎓
          </div>
        ...
        <button
          type="button"
          onClick={logout}
          className="mt-6 w-full rounded-2xl bg-red-50 px-4 py-3 text-sm font-extrabold text-[#EF4444]"
        >
          Log Out
        </button>
      </section>
