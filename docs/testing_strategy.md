...
User testing was conducted during Milestone 3 and recorded in `docs/user_testing_ms3.md`.
...
| ------------- | -----------------------------------------: | -----------: | ----------------------------------------------------------------: | ------------------------------------------------------------------------------------------------------------- |
| Participant 1 |   Core OCR dinner split workflow completed | Not recorded |  Usability confusion around Add, Debts, and settlement visibility | Group creation was easiest; workflow order needed clearer guidance                                            |
| Participant 2 | Navigation and deployment retest completed | Not recorded | Initial group-fetch timeout and navigation active-state confusion | Add active-state logic was corrected, the API timeout was increased, and deployed route refresh was confirmed |
